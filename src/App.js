        ...
        <div data-animation="over-right" data-collapse="medium" data-duration="400" data-easing="ease" data-easing2="ease" data-no-scroll="1" role="banner" className="sktbds-navbar w-nav">
            ...
            <nav role="navigation" className="nav-menu w-nav-menu">
                ...
                <div className="regular-links">
                    <a href="index.html" aria-current="page" className="sktbds-nav-box w--current">HOME</a> <a href="./pages/skatepark.html" className="sktbds-nav-box">SKATEPARK</a> <a href="./pages/mission.html" className="sktbds-nav-box">MISSION</a>
                    <a href="./pages/roadmap.html" className="sktbds-nav-box">ROADMAP</a>
         ...
         <div id="app-cover" className="compress">
        {/* <div id="player">
            <div id="player-content" className="testing">
                <div id="album-art">
                    <img src={Kanye} className="active" id="_1" /> <img src={cloud9} id="_2" /> <img src={MsJackson} id="_3" />
                    <img src={Telepatia} id="_4" /> <img src={Seaside} id="_5" /> <img src={Whirlwind} id="_6" />
                ...
                <div id="player-controls">
                    ...
                    <div className="control" id="control-previous">
                        <div className="button" id="play-previous"><i className="fas fa-backward"></i></div>
                    </div>
                    <div className="control pen-4" id="control-play-pause">
                        <div className="button" id="play-pause-button"><i className="fas fa-play"></i></div>
                    </div>
                    <div className="control" id="control-next">
                        <div className="button" id="play-next"><i className="fas fa-forward"></i></div>
                    </div>
